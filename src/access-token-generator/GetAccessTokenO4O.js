...
module.exports = {
  GetAccessTokenO4O: function (scope) {
    ...
    const aud = `${cfg.config.url.includes('https') ? cfg.config.url : 'https://'.concat(cfg.config.url)}/oauth2/v1/token`; // audience
